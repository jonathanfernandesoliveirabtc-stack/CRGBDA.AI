...
source.include_exts = py,png,jpg,kv,atlas,db,env,mp3
...
requirements = python3,google-generativeai==0.8.4,customtkinter,pillow,pygame,edge-tts,psutil,reque
